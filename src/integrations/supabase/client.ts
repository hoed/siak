...
import { ExtendedDatabase, createExtendedClient } from './chart-of-accounts-types';
...
export const supabase = createExtendedClient(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, {
  auth: {
    persistSession: true,
