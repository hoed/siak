...
import { createInventoryClient } from './inventory-types';
...
// Export the extended client for inventory
export const inventoryClient = createInventoryClient(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, {
  auth: {
    persistSession: true,
